          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 group p-4 rounded-2xl bg-[var(--theme-surface)] border border-[var(--theme-border)]"
              >
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-[var(--theme-surface)] border border-[var(--theme-border)]">
                <div className="w-10 h-10 rounded-xl bg-[var(--brand-primary)]/10 flex items-center justify-center text-[var(--brand-primary)]">
                  <MapPin size={20} />
                </div>
                <div>
